    ...
    <main class="container">
        <div style="text-align: center; max-width: 800px; margin: 0 auto 60px">
            ...
            <!-- <div style="margin-top: 30px">
                <span class="tag">捷運西門站</span>
                <span class="tag">主燈區</span>
                <span class="tag">街頭展演</span>
            </div> -->
        </div>
        ...
        <section class="container">
            ...
            <div id="map-theme-1" class="interactive-map-container map-layer active">
                ...
                <div class="map-hotspot" style="top: 73%; left: 23%; border-color:#FF0055;"
                    onclick="openMapModal('ximen-main')"></div>
                <div class="map-hotspot" style="top: 65%; left: 33%; border-color:#FF0055;"
            ...
            <div id="map-theme-2" class="interactive-map-container map-layer">
                ...
                <div class="map-hotspot" style="top: 53%; left: 48%; border-color:#FFD700;"
                    onclick="openMapModal('artist-1')"></div>
                <div class="map-hotspot" style="top: 25%; left: 60%; border-color:#FFD700;"
            ...
            <div id="map-theme-3" class="interactive-map-container map-layer">
                ...
                <div class="map-hotspot" style="top: 60%; left: 80%; border-color:#C000FF;"
                    onclick="openMapModal('temple-1')"></div>
            </div>

            <div class="info-section">
                <h3
                    style="color:white; margin-bottom:20px; border-left:5px solid var(--accent-color); padding-left:15px;">
                    燈組列表</h3>
