            ...
            <h2 class="section-title">Transportation</h2>
                ...
                <div class="dual-traffic-container">
                    ...
                    <div class="traffic-card">
                        ...
                        <a href="../info/emap-ximen-eng.jpg" target="_blank" class="btn-view-detail" style="margin:15px 10px; padding:15px 30px;">Simple Map</a>
                    ...
                    <div class="traffic-card">
                        ...
                        <a href="../info/emap-expo-eng.jpg" target="_blank" class="btn-view-detail" style="margin:15px 10px; padding:15px 30px;">Simple Map</a>
