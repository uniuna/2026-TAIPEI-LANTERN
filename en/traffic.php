                    ...
                    <div class="traffic-card">
                        ...
                        <ul class="traffic-details">
                            ...
                            <li>
                                <span class="t-icon">🚲</span>
                                <div>
                                    <strong style="color:white; font-size:1.1rem;">YouBike 微笑單車</strong>
                                    <p style="color:var(--text-sub); margin-top:5px;">
                                        • 捷運西門站 3號出口 (遠百旁)<br>
                ...
                <div class="traffic-card" style="margin-top: 40px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px;">
                        ...
                        <div style="display: flex; align-items: start;">
                            <span class="t-icon">🚌</span>
                            <div>
                                <strong style="color:white; font-size:1.1rem;">直達公車 (約20-30分)</strong>
                                <p style="color:var(--text-sub); margin-top:5px;">
                        ...
                        <div style="display: flex; align-items: start;">
                            <span class="t-icon">🚇</span>
                            <div>
                                <strong style="color:white; font-size:1.1rem;">捷運轉乘 (約20-25分)</strong>
                                <p style="color:var(--text-sub); margin-top:5px;">
                        ...
                        <div style="display: flex; align-items: start;">
                            <span class="t-icon">🚲</span>
                            <div>
                                <strong style="color:white; font-size:1.1rem;">YouBike (約20-25分)</strong>
                                <p style="color:var(--text-sub); margin-top:5px;">
