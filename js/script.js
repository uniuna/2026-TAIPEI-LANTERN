...
const mapData = {
    'item_01': {
        ...
        name: '徐志銘',
        size:'依現地樹叢設計',
        desc: '本系列以台北文化為核心，將森林、夜空與建築轉化為能量視覺語彙，形成四座台北具有象徵性的光之門，以圓形構圖、樹影拱門與星軌能量構成沉浸式場域，象徵自然與文明的交會，也引導觀者進入一種穿越的經驗。藝術家以台北建築擬畫抽象圖形，台北 101 象徵科技與城市的未來能量柱；穿越北門，如同踏入城市記憶深處，回望台北的文化源頭；中正紀念堂牌樓承載公共精神與價值，是城市的儀式入口；圓山大飯店的山頭文化能量彷彿是一座文化能量殿堂，遠離喧囂，靜靜守望著城市。系列作品以森林為結界、夜空為能量、建築為文化精神，當光與樹相遇，城市被重新觀看感受，一座座「星樹之門」不只是建築的符號，更是一種穿越；穿越了歷史、文明、空間與自然的邊界。',
    ...
    'item_03': {
        ...
        name: '徐于倫.舒次華',
        size: '以現地樹枝幹可延伸尺寸',
        desc: '作品以樹木作為生命最純粹的象徵，透過光線與能量流動的視覺語彙，展現大自然永不枯竭的生命循環。以現地樹幹為主體，透過向上攀升的生命光條能量自大地湧起，沿著樹脈向外擴散，如同脈搏跳動般持續輸送活力形成向外擴張的光之網絡，象徵生命彼此相連、交織成共同的宇宙。<br>夜間點亮後，整棵樹化為一個光之生命體，脈動柔和卻充滿力量，引導民眾能在光影中感受到自然的呼吸，「生之源」意在傳達生命孕育、循環與成長的哲學寓意，提醒人們生命的源頭從未遠離，它就在我們身邊、在每一次能量流動裡持續綻放，在光影之間重新感受自然的力量與生命自身的美好。',
        img: '../images/item_03.jpg'
    },
